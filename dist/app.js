...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SiteHeader = __webpack_require__(104);

	var _SiteHeader2 = _interopRequireDefault(_SiteHeader);

	var _SiteMain = __webpack_require__(105);

	var _SiteMain2 = _interopRequireDefault(_SiteMain);
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_SiteMain2['default'], null)
	        );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactMount = {
	  ...
	  _updateRootComponent: function () {
	    function _updateRootComponent(prevComponent, nextElement, container, callback) {
	  ...
	  _registerComponent: function () {
	    function _registerComponent(nextComponent, container) {
	   ...
	   */
	  findReactContainerForID: function () {
	    function findReactContainerForID(id) {
	    ...
	    return findReactContainerForID;
	  }(),
	   ...
	   */
	  findReactNodeByID: function () {
	    function findReactNodeByID(id) {
	      var reactRoot = ReactMount.findReactContainerForID(id);
	      return ReactMount.findComponentRoot(reactRoot, id);
	    }

	    return findReactNodeByID;
	  }(),
	   ...
	   * @internal
	   */
	  getFirstReactDOM: function () {
	    function getFirstReactDOM(node) {
	      return findFirstReactDOMImpl(node);
	    }

	    return getFirstReactDOM;
	  }(),
	  ...
	  findComponentRoot: function () {
	    ...
	    return findComponentRoot;
	  }(),

	  _mountImageIntoNode: function () {
	    function _mountImageIntoNode(markup, container, shouldReuseMarkup, transaction) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactPerf = {
	  ...
	  measureMethods: function () {
	    function measureMethods(object, objectName, methodNames) {
	      if (process.env.NODE_ENV !== 'production') {
	   ...
	   */
	  measure: function () {
	    function measure(objName, fnName, func) {
	      if (process.env.NODE_ENV !== 'production') {
	  ...
	  injection: {
	     ...
	     */
	    injectMeasure: function () {
	      function injectMeasure(measure) {
	        ReactPerf.storedMeasure = measure;
	      }

	      return injectMeasure;
	    }()
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fiveArgumentPooler = function () {
	  function fiveArgumentPooler(a1, a2, a3, a4, a5) {
	    var Klass = this;
	    if (Klass.instancePool.length) {
	      var instance = Klass.instancePool.pop();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = {
	   ...
	   */
	  getDefaultValueForProperty: function () {
	    ...
	    return getDefaultValueForProperty;
	  }(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactReconciler = {
	  ...
	  mountComponent: function () {
	    function mountComponent(internalInstance, rootID, transaction, context) {
	  ...
	  unmountComponent: function () {
	    function unmountComponent(internalInstance) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = {
	  ...
	  createReactRootID: function () {
	    function createReactRootID() {
	      return getReactRootIDString(ReactRootIndex.createReactRootIndex());
	    }

	    return createReactRootID;
	  }(),
	   ...
	   * @internal
	   */
	  createReactID: function () {
	    function createReactID(rootID, name) {
	      return rootID + name;
	    }

	    return createReactID;
	  }(),
	   ...
	   * @internal
	   */
	  getReactRootIDFromNodeID: function () {
	    function getReactRootIDFromNodeID(id) {
	    ...
	    return getReactRootIDFromNodeID;
	  }(),
	  ...
	  traverseEnterLeave: function () {
	    function traverseEnterLeave(leaveID, enterID, cb, upArg, downArg) {
	   ...
	   */
	  traverseTwoPhaseSkipTarget: function () {
	    function traverseTwoPhaseSkipTarget(targetID, cb, arg) {
	      if (targetID) {
	    ...
	    return traverseTwoPhaseSkipTarget;
	  }(),
	  ...
	  traverseAncestors: function () {
	    function traverseAncestors(targetID, cb, arg) {
	      traverseParentPath('', targetID, cb, arg, true, false);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPluginHub = {
	  ...
	  injection: {
	     ...
	     * @public
	     */
	    injectInstanceHandle: function () {
	      function injectInstanceHandle(InjectedInstanceHandle) {
	  ...
	  getListener: function () {
	    function getListener(id, registrationName) {
	  ...
	  deleteListener: function () {
	    function deleteListener(id, registrationName) {
	      var PluginModule = EventPluginRegistry.registrationNameModules[registrationName];
	  ...
	  deleteAllListeners: function () {
	    function deleteAllListeners(id) {
	  ...
	  extractEvents: function () {
	    function extractEvents(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent, nativeEventTarget) {
	      var events;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  var warnUnknownProperty = function () {
	    function warnUnknownProperty(name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentBrowserEnvironment = {
	  ...
	  unmountIDFromEnvironment: function () {
	    function unmountIDFromEnvironment(rootNodeID) {
	      ReactMount.purgeID(rootNodeID);
	    }

	    return unmountIDFromEnvironment;
	  }()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMIDOperations = {
	  ...
	  updatePropertyByID: function () {
	    function updatePropertyByID(id, name, value) {
	  ...
	  dangerouslyProcessChildrenUpdates: function () {
	    function dangerouslyProcessChildrenUpdates(updates, markup) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactUpdateQueue = {
	  ...
	  enqueueSetProps: function () {
	    function enqueueSetProps(publicInstance, partialProps) {
	    ...
	    return enqueueSetProps;
	  }(),

	  enqueueSetPropsInternal: function () {
	    function enqueueSetPropsInternal(internalInstance, partialProps) {
	    ...
	    return enqueueSetPropsInternal;
	  }(),
	  ...
	  enqueueReplaceProps: function () {
	    function enqueueReplaceProps(publicInstance, props) {
	    ...
	    return enqueueReplaceProps;
	  }(),

	  enqueueReplacePropsInternal: function () {
	    function enqueueReplacePropsInternal(internalInstance, props) {
	      var topLevelWrapper = internalInstance._topLevelWrapper;
	    ...
	    return enqueueReplacePropsInternal;
	  }(),

	  enqueueElementInternal: function () {
	    function enqueueElementInternal(internalInstance, newElement) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (process.env.NODE_ENV !== 'production') {
	  ...
	  validateDOMNesting = function () {
	    function validateDOMNesting(childTag, childInstance, ancestorInfo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditSetItemForm = __webpack_require__(95);

	var _EditSetItemForm2 = _interopRequireDefault(_EditSetItemForm);
	...
	function SetItemText(props) {
	  return _react2['default'].createElement(
	    'div',
	    { className: 'row setItem set-space', onClick: props.onClick },
	    _react2['default'].createElement(
	      'div',
	      { className: 'col-xs-2 col-xs-offset-4' },
	      props.index
	    ),
	    _react2['default'].createElement(
	      'div',
	...
	var SetItem = function (_Component) {
	  _inherits(SetItem, _Component);

	  function SetItem(props) {
	    _classCallCheck(this, SetItem);

	    var _this = _possibleConstructorReturn(this, (SetItem.__proto__ || Object.getPrototypeOf(SetItem)).call(this, props));

	    _this.handleTextClick = function () {
	      _this.setState({ showForm: true });
	    };

	    _this.handleFormClick = function () {
	    ...
	    _this.handleTextClick = _this.handleTextClick.bind(_this);
	  ...
	  _createClass(SetItem, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        if (!showForm) {
	          content = _react2['default'].createElement(SetItemText, { onClick: this.handleTextClick,
	            index: this.props.index,
	            rep: this.props.rep,
	            kg: this.props.kg });
	        } else {
	          content = _react2['default'].createElement(_EditSetItemForm2['default'], { onClick: this.handleFormClick,
	            index: this.props.index,
	            rep: this.props.rep,
	            kg: this.props.kg,
	            onSubmit: onSubmit,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMChildrenOperations = {
	  ...
	  processUpdates: function () {
	    function processUpdates(updates, markupList) {
	      var update;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactClassMixin = {
	   ...
	   */
	  setProps: function () {
	    function setProps(partialProps, callback) {
	      if (process.env.NODE_ENV !== 'production') {
	        warnSetProps();
	      }
	  ...
	  replaceProps: function () {
	    function replaceProps(newProps, callback) {
	      if (process.env.NODE_ENV !== 'production') {
	        warnSetProps();
	      }
	  ...
	  createClass: function () {
	    function createClass(spec) {
	      var Constructor = function () {
	        function Constructor(props, context, updater) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMSelect = {
	  ...
	  getNativeProps: function () {
	    function getNativeProps(inst, props, context) {
	      return assign({}, props, {
	  ...
	  processChildContext: function () {
	    function processChildContext(inst, props, context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMTextComponent = function () {
	  function ReactDOMTextComponent(props) {
	...
	assign(ReactDOMTextComponent.prototype, {
	   ...
	   */
	  mountComponent: function () {
	    function mountComponent(rootID, transaction, context) {
	      if (process.env.NODE_ENV !== 'production') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEmptyComponentInjection = {
	  injectEmptyComponent: function () {
	    function injectEmptyComponent(component) {
	      placeholderElement = ReactElement.createElement(component);
	    }

	    return injectEmptyComponent;
	  }()
	};
	...
	var ReactEmptyComponent = function () {
	  function ReactEmptyComponent(instantiate) {
	    this._currentElement = null;
	    this._rootNodeID = null;
	    this._renderedComponent = instantiate(placeholderElement);
	  }

	  return ReactEmptyComponent;
	}();
	assign(ReactEmptyComponent.prototype, {
	  ...
	  unmountComponent: function () {
	    function unmountComponent(rootID, transaction, context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactNativeComponentInjection = {
	  ...
	  injectComponentClasses: function () {
	    function injectComponentClasses(componentClasses) {
...
/***/ function(module, exports) {
	...
	var ReactRootIndexInjection = {
	   ...
	   */
	  injectCreateReactRootIndex: function () {
	    function injectCreateReactRootIndex(_createReactRootIndex) {
	      ReactRootIndex.createReactRootIndex = _createReactRootIndex;
	    }

	    return injectCreateReactRootIndex;
	  }()
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddExerciseForm = __webpack_require__(90);
	...
	function AddExerciseText(props) {
	  return _react2['default'].createElement(
	    'a',
	    { className: 'add-exercise', onClick: props.onClick },
	    '+ Add an exercise...'
	  );
	}

	var AddExercise = function (_Component) {
	  _inherits(AddExercise, _Component);

	  function AddExercise(props) {
	    _classCallCheck(this, AddExercise);

	    var _this = _possibleConstructorReturn(this, (AddExercise.__proto__ || Object.getPrototypeOf(AddExercise)).call(this, props));
	  ...
	  _createClass(AddExercise, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var onSetChange = this.props.onSetChange;
	        var onSubmit = this.props.onSubmit;

	        if (!showForm) {
	          content = _react2['default'].createElement(AddExerciseText, { onClick: this.handleTextClick });
	        } else {
	          content = _react2['default'].createElement(_AddExerciseForm2['default'], { onClick: this.handleFormClick,
	            title: title,
	            set: set,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddExerciseForm = function (_Component) {
	  ...
	  function AddExerciseForm(props) {
	    ...
	    _this.handleSetChange = _this.handleSetChange.bind(_this);
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2["default"].createElement(
	          ...
	          _react2["default"].createElement(
	            "div",
	            { className: "form-group short-form" },
	            _react2["default"].createElement("input", { type: "text",
	              className: "form-control",
	              placeholder: "Reps",
	              value: set,
	          ...
	          _react2["default"].createElement(
	            "a",
	            { href: "#", className: "close-icon", onClick: this.props.onClick },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddSetForm = __webpack_require__(92);

	var _AddSetForm2 = _interopRequireDefault(_AddSetForm);
	...
	function AddSetText(props) {
	  return _react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	      'div',
	      { className: 'col-xs-6 col-xs-offset-4 add-set-wrapper' },
	      _react2['default'].createElement(
	        'a',
	        { className: 'add-set-text', onClick: props.onClick },
	        '+ Add a set...'
	      )
	    )
	  );
	...
	var AddSet = function (_Component) {
	  _inherits(AddSet, _Component);

	  function AddSet(props) {
	    _classCallCheck(this, AddSet);

	    var _this = _possibleConstructorReturn(this, (AddSet.__proto__ || Object.getPrototypeOf(AddSet)).call(this, props));
	  ...
	  _createClass(AddSet, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var index = this.props.setList.length + 1;

	        if (!showForm) {
	          content = _react2['default'].createElement(AddSetText, { onClick: this.handleTextClick });
	        } else {
	          content = _react2['default'].createElement(_AddSetForm2['default'], { onClick: this.handleFormClick,
	            index: index,
	            onSubmit: onSubmit });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddSetForm = function (_Component) {
	  _inherits(AddSetForm, _Component);

	  function AddSetForm(props) {
	    _classCallCheck(this, AddSetForm);

	    var _this = _possibleConstructorReturn(this, (AddSetForm.__proto__ || Object.getPrototypeOf(AddSetForm)).call(this, props));
	    ...
	    _this.handleKgChange = _this.handleKgChange.bind(_this);
	    _this.handleSubmit = _this.handleSubmit.bind(_this);
	    return _this;
	  }
	      ...
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-1 input-wrapper' },
	              _react2['default'].createElement('input', { type: 'text',
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-1 text-center time-symbol' },
	              '\xD7'
	            ),
	            _react2['default'].createElement(
	              'div',
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'row set-add set-space' },
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-4 col-xs-offset-8 input-wrapper' },
	              _react2['default'].createElement(
	                'button',
	                { type: 'submit', className: 'btn btn-primary', onClick: this.handleSubmit },
	                'Add'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddWorkoutForm = __webpack_require__(94);

	var _AddWorkoutForm2 = _interopRequireDefault(_AddWorkoutForm);
	...
	function AddWorkoutText(props) {
	  return _react2['default'].createElement(
	    'a',
	    { className: 'add-workout', onClick: props.onClick },
	    '+ Add a workout...'
	  );
	}

	var AddWorkout = function (_Component) {
	  _inherits(AddWorkout, _Component);

	  function AddWorkout(props) {
	    _classCallCheck(this, AddWorkout);

	    var _this = _possibleConstructorReturn(this, (AddWorkout.__proto__ || Object.getPrototypeOf(AddWorkout)).call(this, props));
	  ...
	  _createClass(AddWorkout, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        if (!showForm) {
	          content = _react2['default'].createElement(AddWorkoutText, { onClick: this.handleTextClick });
	        } else {
	          content = _react2['default'].createElement(_AddWorkoutForm2['default'], { onClick: this.handleFormClick,
	            onSubmit: onSubmit });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddWorkoutForm = function (_Component) {
	  _inherits(AddWorkoutForm, _Component);

	  function AddWorkoutForm(props) {
	    _classCallCheck(this, AddWorkoutForm);

	    var _this = _possibleConstructorReturn(this, (AddWorkoutForm.__proto__ || Object.getPrototypeOf(AddWorkoutForm)).call(this, props));
	...
	exports['default'] = AddWorkoutForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditSetItemForm = function (_Component) {
	  _inherits(EditSetItemForm, _Component);

	  function EditSetItemForm(props) {
	    _classCallCheck(this, EditSetItemForm);

	    var _this = _possibleConstructorReturn(this, (EditSetItemForm.__proto__ || Object.getPrototypeOf(EditSetItemForm)).call(this, props));
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              ...
	              _react2['default'].createElement(
	                'button',
	                { type: 'button', className: 'btn btn-danger trash-button', 'aria-label': 'Delete', onClick: this.handleDelete },
	  ...
	  return EditSetItemForm;
	}(_react.Component);

	exports['default'] = EditSetItemForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SetList = __webpack_require__(103);

	var _SetList2 = _interopRequireDefault(_SetList);

	var _AddSet = __webpack_require__(91);

	var _AddSet2 = _interopRequireDefault(_AddSet);

	var _ExerciseNotes = __webpack_require__(102);

	var _ExerciseNotes2 = _interopRequireDefault(_ExerciseNotes);

	var _ExerciseHistory = __webpack_require__(99);

	var _ExerciseHistory2 = _interopRequireDefault(_ExerciseHistory);

	var _ExerciseHeader = __webpack_require__(97);

	var _ExerciseHeader2 = _interopRequireDefault(_ExerciseHeader);
	...
	var Exercise = function (_Component) {
	  ...
	  function Exercise(props) {
	    ...
	    _this.handleSubmit = _this.handleSubmit.bind(_this);
	    _this.handleSetEdit = _this.handleSetEdit.bind(_this);
	    _this.handleSetDelete = _this.handleSetDelete.bind(_this);
	    _this.handleExerciseFinish = _this.handleExerciseFinish.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Exercise, [{
	    key: 'handleSubmit',
	    value: function () {
	      function handleSubmit(rep, kg) {
	        var setList = this.state.setList.slice();
	        var index = setList.length + 1;
	    ...
	    key: 'handleSetEdit',
	    value: function () {
	      function handleSetEdit(index, rep, kg) {
	        var setList = this.state.setList.slice();
	        var setItem = { id: index, rep: rep, kg: kg };
	        setList[index - 1] = setItem;
	        this.setState({ setList: setList });
	      }

	      return handleSetEdit;
	    }()
	  }, {
	    key: 'handleSetDelete',
	    value: function () {
	      function handleSetDelete(index) {
	        var setList = this.state.setList.slice();
	        ...
	        try {
	          for (var _iterator = setList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            setItem = _step.value;
	      ...
	      return handleSetDelete;
	    }()
	  }, {
	    key: 'handleExerciseFinish',
	    value: function () {
	      function handleExerciseFinish(e) {
	      ...
	      return handleExerciseFinish;
	    }()
	  }, {
	    key: 'render',
	    value: function () {
	      function render() {
	        var targetId = "#myModal" + this.props.workoutIndex.toString() + this.props.index.toString();
	        var target = "myModal" + this.props.workoutIndex.toString() + this.props.index.toString();
	        var onNotesChange = this.props.onNotesChange;
	        var onExerciseChange = this.props.onExerciseChange;
	        var onExerciseDelete = this.props.onExerciseDelete;
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'a',
	              { className: 'exercise-details', 'data-toggle': 'modal', 'data-target': targetId },
	              _react2['default'].createElement(
	                'div',
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'modal fade', id: target, tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'mySmallModalLabel' },
	              _react2['default'].createElement(
	                'div',
	                ...
	                _react2['default'].createElement(
	                  ...
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(_ExerciseHeader2['default'], { title: this.props.title,
	                      set: this.props.set,
	                  ...
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(_ExerciseNotes2['default'], { onNotesChange: onNotesChange,
	                      index: this.props.index,
	                      note: this.props.notes }),
	                    _react2['default'].createElement(
	                      'div',
	                      { className: 'row exercise-history set-space' },
	                      _react2['default'].createElement(
	                        'div',
	                        { className: 'col-xs-2 small-title' },
	                        'History'
	                      ),
	                      _react2['default'].createElement(
	                        'div',
	                    ...
	                    _react2['default'].createElement(_ExerciseHistory2['default'], { setList: this.props.exerciseHistory }),
	                    _react2['default'].createElement('hr', null),
	                    _react2['default'].createElement(
	                      'div',
	                      { className: 'row exercise-record set-space' },
	                      _react2['default'].createElement(
	                        'div',
	                        { className: 'col-xs-2 small-title' },
	                        'Today'
	                    ...
	                    _react2['default'].createElement(_SetList2['default'], { setList: this.state.setList,
	                      onSubmit: this.handleSetEdit,
	                      onDelete: this.handleSetDelete }),
	                    _react2['default'].createElement(_AddSet2['default'], { setList: this.state.setList,
	                  ...
	                  _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                      'button',
	                      { type: 'button', className: 'btn btn-primary exercise-finish', onClick: this.handleExerciseFinish },
	                      'Finish Exercise'
	                    )
	                  )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExerciseHeaderForm = __webpack_require__(98);

	var _ExerciseHeaderForm2 = _interopRequireDefault(_ExerciseHeaderForm);
	...
	var ExerciseHeader = function (_Component) {
	  _inherits(ExerciseHeader, _Component);

	  function ExerciseHeader(props) {
	    _classCallCheck(this, ExerciseHeader);

	    var _this = _possibleConstructorReturn(this, (ExerciseHeader.__proto__ || Object.getPrototypeOf(ExerciseHeader)).call(this, props));
	      ...
	      function render() {
	        ...
	        if (!showForm) {
	          content = _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'h4',
	              { className: 'modal-title exercise-modal-title', id: 'myModalLabel' },
	              this.props.title,
	              ' - ',
	              this.props.set,
	              ' Sets'
	            ),
	            _react2['default'].createElement('span', { className: 'glyphicon glyphicon-pencil title-icon title-icon-pencil', 'aria-hidden': 'true', onClick: this.handleTextClick }),
	            _react2['default'].createElement('span', { className: 'glyphicon glyphicon-trash title-icon title-icon-trash', 'aria-hidden': 'true', 'data-dismiss': 'modal', onClick: this.handleDelete })
	          );
	        } else {
	          content = _react2['default'].createElement(_ExerciseHeaderForm2['default'], { onClick: this.handleFormClick,
	            onExerciseChange: onExerciseChange,
	            index: this.props.index });
	        }
	...
	exports['default'] = ExerciseHeader;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExerciseHeaderForm = function (_Component) {
	  _inherits(ExerciseHeaderForm, _Component);

	  function ExerciseHeaderForm(props) {
	    _classCallCheck(this, ExerciseHeaderForm);

	    var _this = _possibleConstructorReturn(this, (ExerciseHeaderForm.__proto__ || Object.getPrototypeOf(ExerciseHeaderForm)).call(this, props));
	  ...
	  _createClass(ExerciseHeaderForm, [{
	    key: 'handleTitleChange',
	    value: function () {
	      function handleTitleChange(e) {
	        this.setState({
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          'form',
	          { className: 'form-inline exercise-header-form' },
	          _react2['default'].createElement(
	            'div',
	  ...
	  return ExerciseHeaderForm;
	}(_react.Component);

	exports['default'] = ExerciseHeaderForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExerciseHistoryItem = __webpack_require__(100);

	var _ExerciseHistoryItem2 = _interopRequireDefault(_ExerciseHistoryItem);
	...
	var ExerciseHistory = function (_Component) {
	  _inherits(ExerciseHistory, _Component);

	  function ExerciseHistory() {
	    _classCallCheck(this, ExerciseHistory);

	    return _possibleConstructorReturn(this, (ExerciseHistory.__proto__ || Object.getPrototypeOf(ExerciseHistory)).apply(this, arguments));
	  }

	  _createClass(ExerciseHistory, [{
	    key: 'render',
	    value: function () {
	      function render() {
	        var setList = this.props.setList;

	        var listItems = setList.map(function (set) {
	          return _react2['default'].createElement(_ExerciseHistoryItem2['default'], { key: set.id,
	            index: set.id,
	            rep: set.rep,
	            kg: set.kg });
	        });
	...
	exports['default'] = ExerciseHistory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SetItem = __webpack_require__(53);
	...
	var ExerciseHistoryItem = function (_Component) {
	  _inherits(ExerciseHistoryItem, _Component);

	  function ExerciseHistoryItem() {
	    _classCallCheck(this, ExerciseHistoryItem);

	    return _possibleConstructorReturn(this, (ExerciseHistoryItem.__proto__ || Object.getPrototypeOf(ExerciseHistoryItem)).apply(this, arguments));
	  }

	  _createClass(ExerciseHistoryItem, [{
	    key: 'render',
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	...
	exports['default'] = ExerciseHistoryItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Exercise = __webpack_require__(96);
	  ...
	  _createClass(ExerciseList, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var onExerciseFinish = this.props.onExerciseFinish;
	        var onNotesChange = this.props.onNotesChange;
	        var onExerciseChange = this.props.onExerciseChange;
	        var onExerciseDelete = this.props.onExerciseDelete;

	        var listItems = exerciseList.map(function (exercise) {
	          return _react2['default'].createElement(_Exercise2['default'], { key: exercise.id,
	            title: exercise.title,
	            set: exercise.set,
	            index: exercise.id,
	            workoutIndex: _this2.props.index,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactEditInline = __webpack_require__(128);
	...
	var ExerciseNotes = function (_Component) {
	  _inherits(ExerciseNotes, _Component);

	  function ExerciseNotes(props) {
	    _classCallCheck(this, ExerciseNotes);

	    var _this = _possibleConstructorReturn(this, (ExerciseNotes.__proto__ || Object.getPrototypeOf(ExerciseNotes)).call(this, props));

	    _this.handleNoteChange = _this.handleNoteChange.bind(_this);
	    _this.customValidateText = _this.customValidateText.bind(_this);
	    return _this;
	  }

	  _createClass(ExerciseNotes, [{
	    key: 'handleNoteChange',
	    value: function () {
	      function handleNoteChange(note) {
	        this.setState(_extends({}, note));
	      ...
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-12 modal-note-title' },
	              _react2['default'].createElement(
	                'span',
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: 'row note-edit set-space' },
	            _react2['default'].createElement(
	              'div',
	              { className: 'col-xs-12' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SetList = function (_Component) {
	  _inherits(SetList, _Component);

	  function SetList() {
	    _classCallCheck(this, SetList);

	    return _possibleConstructorReturn(this, (SetList.__proto__ || Object.getPrototypeOf(SetList)).apply(this, arguments));
	  }
	  ...
	  _createClass(SetList, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        var listItems = setList.map(function (set) {
	          return _react2['default'].createElement(_SetItem2['default'], { key: set.id,
	            index: set.id,
	            rep: set.rep,
	            kg: set.kg,
	            onSubmit: onSubmit,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkoutBoard = __webpack_require__(107);

	var _WorkoutBoard2 = _interopRequireDefault(_WorkoutBoard);

	var _WorkoutHeader = __webpack_require__(108);

	var _WorkoutHeader2 = _interopRequireDefault(_WorkoutHeader);
	...
	var SiteMain = function (_Component) {
	  _inherits(SiteMain, _Component);

	  function SiteMain() {
	    _classCallCheck(this, SiteMain);

	    return _possibleConstructorReturn(this, (SiteMain.__proto__ || Object.getPrototypeOf(SiteMain)).apply(this, arguments));
	  }
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          'div',
	          { id: 'SiteMain' },
	          _react2['default'].createElement(_WorkoutHeader2['default'], null),
	          _react2['default'].createElement(_WorkoutBoard2['default'], null)
	        );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkoutTitle = __webpack_require__(111);

	var _WorkoutTitle2 = _interopRequireDefault(_WorkoutTitle);

	var _ExerciseList = __webpack_require__(101);

	var _ExerciseList2 = _interopRequireDefault(_ExerciseList);

	var _AddExercise = __webpack_require__(89);
	...
	var Workout = function (_Component) {
	  ...
	  function Workout(props) {
	    ...
	    var exerciseListName = "exerciseList" + _this.props.index;
	    var exerciseList = [];
	    ...
	    _this.handleExerciseDelete = _this.handleExerciseDelete.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Workout, [{
	    ...
	    value: function () {
	      function addNewExercise() {
	        var exerciseList = this.state.exerciseList.slice();
	        var index = exerciseList.length + 1;
	        ...
	        var exerciseListName = "exerciseList" + this.props.index;
	    ...
	    value: function () {
	      function handleExerciseChange(index, title, set) {
	        var exerciseList = this.state.exerciseList.slice();
	    ...
	    value: function () {
	      function handleExerciseDelete(index) {
	        ...
	        try {
	          for (var _iterator = exerciseList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            exerciseItem = _step.value;
	      ...
	      return handleExerciseDelete;
	    }()
	  }, {
	    key: 'handleExerciseFinish',
	    value: function () {
	      function handleExerciseFinish(index, setList) {
	        var exerciseList = this.state.exerciseList.slice();
	    ...
	    value: function () {
	      function handleNotesChange(index, notes) {
	        var exerciseList = this.state.exerciseList.slice();
	    ...
	    value: function () {
	      function render() {
	        ...
	        return _react2['default'].createElement(
	          'div',
	          { id: 'Workout' },
	          _react2['default'].createElement(_WorkoutTitle2['default'], { title: this.props.title,
	            onTitleSubmit: onSubmit,
	            onDelete: onDelete,
	            index: this.props.index }),
	          _react2['default'].createElement(_ExerciseList2['default'], { exerciseList: this.state.exerciseList,
	            index: this.props.index,
	          ...
	          _react2['default'].createElement(_AddExercise2['default'], { title: this.state.newTitle,
	            set: this.state.newSet,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLocalstorage = __webpack_require__(130);

	var _reactLocalstorage2 = _interopRequireDefault(_reactLocalstorage);

	var _WorkoutList = __webpack_require__(110);

	var _WorkoutList2 = _interopRequireDefault(_WorkoutList);

	var _AddWorkout = __webpack_require__(93);

	var _AddWorkout2 = _interopRequireDefault(_AddWorkout);
	...
	var WorkoutBoard = function (_Component) {
	  _inherits(WorkoutBoard, _Component);

	  function WorkoutBoard(props) {
	    _classCallCheck(this, WorkoutBoard);

	    var _this = _possibleConstructorReturn(this, (WorkoutBoard.__proto__ || Object.getPrototypeOf(WorkoutBoard)).call(this, props));
	    ...
	    _this.handleSubmit = _this.handleSubmit.bind(_this);
	    _this.handleTitleChange = _this.handleTitleChange.bind(_this);
	    _this.handleWorkoutDelete = _this.handleWorkoutDelete.bind(_this);
	    return _this;
	  }

	  _createClass(WorkoutBoard, [{
	    key: 'handleSubmit',
	    value: function () {
	      function handleSubmit(title) {
	        var workoutList = this.state.workoutList.slice();
	        var index = workoutList.length + 1;
	    ...
	    value: function () {
	      function handleTitleChange(index, title) {
	        var workoutList = this.state.workoutList.slice();
	        var workout = { id: index, title: title };
	    ...
	    value: function () {
	      function handleWorkoutDelete(index) {
	        ...
	        try {
	          for (var _iterator = workoutList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            workoutItem = _step.value;
	        ...
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'div',
	              { className: 'board' },
	              _react2['default'].createElement(_WorkoutList2['default'], { workoutList: this.state.workoutList,
	                onSubmit: this.handleTitleChange,
	                onDelete: this.handleWorkoutDelete }),
	              _react2['default'].createElement(_AddWorkout2['default'], { onSubmit: this.handleSubmit })
	            )
	          )
	        );
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkoutHeaderForm = __webpack_require__(109);

	var _WorkoutHeaderForm2 = _interopRequireDefault(_WorkoutHeaderForm);
	...
	function WorkoutHeaderText(props) {
	  return _react2['default'].createElement(
	    'div',
	    { className: 'workout-header-title', onClick: props.onClick },
	    _react2['default'].createElement(
	      'h4',
	      null,
	      props.title
	...
	var WorkoutHeader = function (_Component) {
	  _inherits(WorkoutHeader, _Component);

	  function WorkoutHeader(props) {
	    _classCallCheck(this, WorkoutHeader);

	    var _this = _possibleConstructorReturn(this, (WorkoutHeader.__proto__ || Object.getPrototypeOf(WorkoutHeader)).call(this, props));
	    ...
	    var workoutTitle = 'Click to name your workout plan';
	  ...
	  _createClass(WorkoutHeader, [{
	    ...
	    value: function () {
	      function render() {
	        ...
	        if (!showForm) {
	          content = _react2['default'].createElement(WorkoutHeaderText, { onClick: this.handleTextClick, title: this.state.title });
	        } else {
	          content = _react2['default'].createElement(_WorkoutHeaderForm2['default'], { onClick: this.handleFormClick,
	            onSubmit: this.handleTitleChange });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorkoutHeaderForm = function (_Component) {
	  _inherits(WorkoutHeaderForm, _Component);

	  function WorkoutHeaderForm(props) {
	    _classCallCheck(this, WorkoutHeaderForm);

	    var _this = _possibleConstructorReturn(this, (WorkoutHeaderForm.__proto__ || Object.getPrototypeOf(WorkoutHeaderForm)).call(this, props));
	  ...
	  _createClass(WorkoutHeaderForm, [{
	    key: 'handleTitleChange',
	    value: function () {
	      function handleTitleChange(e) {
	        this.setState({
	  ...
	  return WorkoutHeaderForm;
	}(_react.Component);

	exports['default'] = WorkoutHeaderForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Workout = __webpack_require__(106);
	...
	var WorkoutList = function (_Component) {
	  _inherits(WorkoutList, _Component);

	  function WorkoutList() {
	    _classCallCheck(this, WorkoutList);

	    return _possibleConstructorReturn(this, (WorkoutList.__proto__ || Object.getPrototypeOf(WorkoutList)).apply(this, arguments));
	  }
	  ...
	  _createClass(WorkoutList, [{
	    ...
	    value: function () {
	      function render() {
	        var workoutList = this.props.workoutList;
	        var onSubmit = this.props.onSubmit;
	        var onDelete = this.props.onDelete;

	        var listItems = workoutList.map(function (workout) {
	          return _react2['default'].createElement(_Workout2['default'], { key: workout.id,
	            title: workout.title,
	            onSubmit: onSubmit,
	            onDelete: onDelete,
	            index: workout.id });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WorkoutTitleForm = __webpack_require__(112);

	var _WorkoutTitleForm2 = _interopRequireDefault(_WorkoutTitleForm);

	var _WorkoutTitleText = __webpack_require__(113);

	var _WorkoutTitleText2 = _interopRequireDefault(_WorkoutTitleText);
	...
	var WorkoutTitle = function (_Component) {
	  _inherits(WorkoutTitle, _Component);

	  function WorkoutTitle(props) {
	    _classCallCheck(this, WorkoutTitle);

	    var _this = _possibleConstructorReturn(this, (WorkoutTitle.__proto__ || Object.getPrototypeOf(WorkoutTitle)).call(this, props));
	  ...
	  _createClass(WorkoutTitle, [{
	    key: 'handleTitleChange',
	    value: function () {
	      function handleTitleChange(title) {
	        this.setState(_extends({}, title));
	    ...
	    value: function () {
	      function render() {
	        var showForm = this.state.showForm;
	        var onSubmit = this.props.onTitleSubmit;
	        var onDelete = this.props.onDelete;

	        var content = null;

	        if (!showForm) {
	          content = _react2['default'].createElement(_WorkoutTitleText2['default'], { onClick: this.handleTextClick,
	            title: this.props.title,
	            onDelete: onDelete,
	            index: this.props.index });
	        } else {
	          content = _react2['default'].createElement(_WorkoutTitleForm2['default'], { onClick: this.handleFormClick,
	            onSubmit: onSubmit,
	            index: this.props.index,
	            title: this.props.title });
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorkoutTitleForm = function (_Component) {
	  _inherits(WorkoutTitleForm, _Component);

	  function WorkoutTitleForm(props) {
	    _classCallCheck(this, WorkoutTitleForm);

	    var _this = _possibleConstructorReturn(this, (WorkoutTitleForm.__proto__ || Object.getPrototypeOf(WorkoutTitleForm)).call(this, props));
	  ...
	  return WorkoutTitleForm;
	}(_react.Component);

	exports['default'] = WorkoutTitleForm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WorkoutTitleText = function (_Component) {
	  _inherits(WorkoutTitleText, _Component);

	  function WorkoutTitleText(props) {
	    _classCallCheck(this, WorkoutTitleText);

	    var _this = _possibleConstructorReturn(this, (WorkoutTitleText.__proto__ || Object.getPrototypeOf(WorkoutTitleText)).call(this, props));
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'a',
	            { href: '#', className: 'close-icon', onClick: this.handleDelete },
	            _react2['default'].createElement('i', { className: 'fa fa-times', 'aria-hidden': 'true' })
	          )
	        );
	      }
	  ...
	  return WorkoutTitleText;
	}(_react.Component);

	exports['default'] = WorkoutTitleText;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var warn = __webpack_require__(129);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Danger = {
	   ...
	   * @internal
	   */
	  dangerouslyRenderMarkup: function () {
	    function dangerouslyRenderMarkup(markupList) {
	    ...
	    return dangerouslyRenderMarkup;
	  }(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var injection = {
	  Mount: null,
	  injectMount: function () {
	    function injectMount(InjectedMount) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactChildReconciler = {
	  ...
	  instantiateChildren: function () {
	    function instantiateChildren(nestedChildNodes, transaction, context) {
	  ...
	  updateChildren: function () {
	    function updateChildren(prevChildren, nextChildren, transaction, context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCompositeComponentMixin = {
	  ...
	  _processProps: function () {
	    function _processProps(newProps) {
	      if (process.env.NODE_ENV !== 'production') {
	        var Component = this._currentElement.type;
	  ...
	  _checkPropTypes: function () {
	    function _checkPropTypes(propTypes, props, location) {
	  ...
	  _replaceNodeWithMarkupByID: function () {
	    function _replaceNodeWithMarkupByID(prevComponentID, nextMarkup) {
	      ReactComponentEnvironment.replaceNodeWithMarkupByID(prevComponentID, nextMarkup);
	    }

	    return _replaceNodeWithMarkupByID;
	  }(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOMComponent.Mixin = {
	  ...
	  _createInitialChildren: function () {
	    function _createInitialChildren(transaction, props, context, el) {
	      // Intentional use of != to avoid catching zero/false.
	      var innerHTML = props.dangerouslySetInnerHTML;
	      if (innerHTML != null) {
	        if (innerHTML.__html != null) {
	  ...
	  _updateDOMProperties: function () {
	    function _updateDOMProperties(lastProps, nextProps, transaction, node) {
	      var propKey;
	      var styleName;
	      var styleUpdates;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMInput = {
	  ...
	  mountReadyWrapper: function () {
	    function mountReadyWrapper(inst) {
	      // Can't be in mountWrapper or else server rendering leaks.
	      instancesByReactID[inst._rootNodeID] = inst;
	    }

	    return mountReadyWrapper;
	  }(),

	  unmountWrapper: function () {
	    function unmountWrapper(inst) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDefaultPerf = {
	  ...
	  printExclusive: function () {
	    function printExclusive(measurements) {
	    ...
	    return printExclusive;
	  }(),

	  printInclusive: function () {
	    function printInclusive(measurements) {
	      measurements = measurements || ReactDefaultPerf._allMeasurements;
	    ...
	    return printInclusive;
	  }(),

	  getMeasurementsSummaryMap: function () {
	    ...
	    return getMeasurementsSummaryMap;
	  }(),

	  printWasted: function () {
	    function printWasted(measurements) {
	      measurements = measurements || ReactDefaultPerf._allMeasurements;
	  ...
	  _recordWrite: function () {
	    function _recordWrite(id, fnName, totalTime, args) {
	  ...
	  measure: function () {
	    function measure(moduleName, fnName, func) {
	      return function () {
	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	          args[_key] = arguments[_key];
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactEventEmitterMixin = {
	  ...
	  handleTopLevel: function () {
	    function handleTopLevel(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent, nativeEventTarget) {
	...
	var ReactMultiChild = {
	  ...
	  Mixin: {
	    ...
	    _reconcilerUpdateChildren: function () {
	      function _reconcilerUpdateChildren(prevChildren, nextNestedChildrenElements, transaction, context) {
	        var nextChildren;
	        if (process.env.NODE_ENV !== 'production') {
	          if (this._currentElement) {
	            try {
	    ...
	    _mountChildByNameAtIndex: function () {
	      function _mountChildByNameAtIndex(child, name, index, transaction, context) {
	        // Inlined for performance, see `ReactInstanceHandles.createReactID`.
	        var rootID = this._rootNodeID + name;
	        var mountImage = ReactReconciler.mountComponent(child, rootID, transaction, context);
	        child._mountIndex = index;
	      ...
	      return _mountChildByNameAtIndex;
	    }(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectEventPlugin = {
	  ...
	  didPutListener: function () {
	    function didPutListener(id, registrationName, listener) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimpleEventPlugin = {
	  ...
	  willDeleteListener: function () {
	    function willDeleteListener(id, registrationName) {
	      if (registrationName === ON_CLICK_KEY) {
